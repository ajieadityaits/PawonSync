...
import { Bell, ChevronRight, ClipboardList, CookingPot, Soup, Sparkles } from "lucide-react";
import { MobileAppShell } from "@/components/MobileAppShell";
import { StatusBadge } from "@/components/StatusBadge";
import { menus, sellerDailyBriefs, sellerProfile } from "@/lib/data";
        ...
        >
          <span className="flex items-center gap-3">
            ...
            <span>
              ...
              <span className="block text-xs font-semibold text-cocoa-500">Atur menu, gambar plate, porsi, dan panduan dapur.</span>
            </span>
          </span>
