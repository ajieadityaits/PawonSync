        ...
        <article className="rounded-3xl border border-cocoa-100 bg-white p-4 shadow-soft">
          <div className="flex items-start justify-between gap-3">
            <div>
              ...
              <p className="mt-2 text-xs font-semibold leading-5 text-cocoa-500">
                Kelola gambar menu, standar porsi, dummy plate, dan pesanan buyer yang masuk hari ini.
              </p>
            </div>
          ...
          <div className="mt-4 grid grid-cols-2 gap-3">
            <div className="rounded-2xl bg-cream-50 p-3">
              <p className="text-2xl font-black text-cocoa-900">{activeMenus}</p>
      ...
      <section className="mt-6 px-4">
        <div className="rounded-xl border border-cocoa-100 bg-white p-4 text-xs font-semibold leading-5 text-cocoa-600 shadow-sm">
          <p className="flex items-start gap-2">
            ...
            Untuk prototype, tombol edit/gambar sudah disiapkan di UI. Penyimpanan permanen bisa disambungkan ke tabel menus dan storage Supabase pada tahap berikutnya.
          </p>
        </div>
      </section>
    </MobileAppShell>
