    ...
    <main className="min-h-screen bg-[linear-gradient(180deg,#fffbea_0%,#dff3d2_100%)] lg:grid lg:place-items-center lg:py-8">
      <section className="min-h-screen w-full bg-cream-50 lg:min-h-[820px] lg:max-w-[430px] lg:overflow-hidden lg:rounded-[28px] lg:border lg:border-cocoa-100 lg:bg-white lg:shadow-soft">
        ...
        <div className="px-5 py-7">
          <div className="mb-7 rounded-3xl border border-sage-100 bg-sage-50 p-5">
            <PackageCheck className="text-sage-800" size={32} />
            <p className="mt-3 text-sm font-semibold leading-6 text-cocoa-600">
              Pantau status pesanan, foto progres, estimasi kedatangan, dan kontak seller dalam satu aplikasi.
            </p>
          </div>
          <AuthForm
            registerLabel="Belum punya akun? Daftar"
            role="buyer"
            subtitle="Pantau pesanan katering Anda dengan mudah dan transparan."
